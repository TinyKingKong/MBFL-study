...
def generate_muse_lines_suspicious_vector(mutants_suspicious_vector, program_data_path):
    ...
    for l in range(len(m_index_list) - 1):
        ...
        for idx in range(m_index_list[l] - 1, m_index_list[l + 1] - 1):
            sum_m += mutants_suspicious_vector[idx]
        lines_suspicious_score.append(sum_m / mutants_num)
